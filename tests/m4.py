...
try:
    # multivariate_normal in scipy.stats is a generator object, not a class.
    # We check if the object has the 'pdf' method and belongs to the expected module.
    assert hasattr(gaussian_class_0, 'pdf'), "gaussian_class_0 should have a 'pdf' method"
    assert hasattr(gaussian_class_1, 'pdf'), "gaussian_class_1 should have a 'pdf' method"
    assert "multivariate_normal" in str(type(gaussian_class_0)), "gaussian_class_0 should be a multivariate_normal object"
    assert "multivariate_normal" in str(type(gaussian_class_1)), "gaussian_class_1 should be a multivariate_normal object"
